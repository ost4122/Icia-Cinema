...
<td>작성자</td>
 ...
 <tr>
   ...
   <%--  <td>${notice.noticeWriter}</td> --%>
    <td>
    <a href="noticeView?noticeNumber=${notice.noticeNumber}&page=${paging.page}">${notice.noticeSubject}</a></td>
 ...
 <tr>
   <td>${search.noticeNumber}</td>
    <td>${search.noticeWriter}</td>
    <td>
    <a href="noticeView?noticeNumber=${search.noticeNumber}&page=${paging.page}">${search.noticeSubject}</a></td>
    <td>${search.noticeDate}</td>
    <td>${search.noticeHit}</td>
 </tr>
 </c:forEach>
</table>
...
<div class="pager" align="center">
        ...
        <br>
		<a href="noticeListOrder">조회수순 정렬</a><br>
</div>	
...
<!-- 검색창 -->
<form name="noticeSearch" method="post" action="noticeSearch"
      align="center" >
...
<input type="text" name="noticeSearch" style=" width: 30%; position:relative; left: 0px; display:inline-block;">
